  ...
  return (
    <div className="App">
      ...
      <ChatTranscriptComponent
        cancelStatus={assistantStore.cancelStatus}
      ...
      <ChatInputComponent
        disabled={(!assistantStore.thread && !appConfig.isAssistantMocked) || assistantStore.isLoadingResponse || assistantStore.isCancelling}
        isCancelling={assistantStore.isCancelling}
        ...
        onCancel={assistantStore.handleCancel}
