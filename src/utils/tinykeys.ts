/**
 * This is a copy of the tinykeys library (https://github.com/jamiebuilds/tinykeys)
 * It was copied from v3.0.0.
 * It was modified to fix an issue where events from iframes would not work correctly.
 * Specifically, the original library used `event instanceof KeyboardEvent` to
 * check if the event was a keyboard event.  This does not work for events
 * coming from iframes.  This copy uses a different method to check the event type.
 */
