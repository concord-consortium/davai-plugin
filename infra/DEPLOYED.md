...
| resource | value |
|---|---|
| AgentCore runtime | `davai_agentcore_staging-guJgof856F` (image `davai-agentcore-backend:models2-20260823`) |
...
parameter (images: `models2-20260823` = current, earlier tags = prior).
