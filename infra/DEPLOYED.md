...
| resource | value |
|---|---|
| AgentCore runtime | `davai_agentcore_staging-guJgof856F` (image `davai-agentcore-backend:sse-20260714`) |
...
parameter (images: `sse-20260714` = current, `pre-sse` = pre-streaming rollback).
